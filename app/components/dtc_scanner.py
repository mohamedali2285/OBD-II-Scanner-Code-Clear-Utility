...
def clear_codes_dialog() -> rx.Component:
    return rx.el.dialog(
        rx.el.div(
            rx.el.h3(
                "Confirm Clear Codes", class_name="text-xl font-bold text-gray-800 mb-4"
            ),
            rx.el.div(
                rx.icon("flag_triangle_right", class_name="text-red-500 mr-3", size=32),
                rx.el.div(
                    rx.el.p(
            ...
            rx.el.div(
                ...
                rx.el.button(
                    ...
                    is_loading=OBDState.is_clearing_codes,
        ...
        open=OBDState.show_clear_dialog,
    )
        ...
        rx.el.div(
            ...
            rx.el.div(
                rx.el.button(
                    ...
                    is_loading=OBDState.is_scanning_dtcs,
        ...
        rx.el.div(
            rx.cond(
                ...
                rx.cond(
                    ...
                    rx.el.div(
                        rx.icon(
                            "square_check", class_name="text-green-500 mb-2", size=48
                        ),
                        rx.el.p(
